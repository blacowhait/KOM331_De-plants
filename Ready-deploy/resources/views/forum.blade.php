      ...
      <div class="navsearch-logo">
        ...
        <a href="/profile">
          <div class="sm-profile-pic">
            ...
            <img src="{{asset('Picture/samplemarketplace.pn')}}" class="iconsmall">
          </div>
        </a>
      </div>
    ...
    <div class="maincontent">
      ...
      <div class="forums">
        ...
        <div class="forum-list">
          <a href="/forumfull">
            <div class="forum-box">
              <span class="maintext"><strong>{{auth()->user()->ftitle}}</strong></span>
              <br>
              <span class="maintext">{{auth()->user()->fquestion}}</span>
            </div>
          </a>
