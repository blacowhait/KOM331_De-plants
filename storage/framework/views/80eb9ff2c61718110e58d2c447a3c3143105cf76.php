...
<html lang="en">
  ...
  <body class="mainbody">
    ...
    <div class="navbar">
      ...
      <label class="ContactUS"><a href="<?php echo e(route('contact')); ?>">Contact Us</a></label>
    ...
    <div class="picloc">
      <img src="<?php echo e(asset('Picture/pic1.png')); ?>">
    </div>
...
<?php /**PATH /home/user/laravel/plant-website(backend)/resources/views/prepage.blade.php ENDPATH**/ ?>